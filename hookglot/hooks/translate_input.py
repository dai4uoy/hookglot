...
def main():
    ...
    # Master Prompt (CLAUDE.md) handles behavior rules — don't duplicate here.
    # Keep this context minimal to save tokens. (v1.4.0 fix: was ~80 tokens,
    # now ~20 tokens.)
    context = f"[Translation hint — user's prompt in English: {translated}]"
